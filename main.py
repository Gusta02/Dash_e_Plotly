...
# localização de territorios brasileiros
...
# grafico mapa
fig = px.choropleth_mapbox(df_states_, locations='estado', color='casosNovos',center={'lat': -16.95,"lon": -47.78},zoom=4 , geojson=brasil_states, color_continuous_scale='Redor', opacity=0.4, hover_data={"casosAcumulado": True, "casosNovos": True,"obitosNovos":True, "estado":True })
...
#         dbc.Col([
#             html.Div([
#                 html.Img(id='logo', src=app.get_asset_url('Logo_Original.png'), height=50),
...
#                        ])
#                    ], color='light', outline=True, style={"margin-top": "10px", "box-shadow": "0 4px 0 rgba(0, 0, 0, 0.15), 0 4px 20px 0 rgba(0, 0, 0, 0.15)", "color":"#ffffff"})
#                ], md=4),
#                dbc.Col([
#                    dbc.Card([
#                        dbc.CardBody([
...
#            ]),
#                 html.Div([
#                 html.P("Selecione que tipo de dado deseja visualizar:", style={"margin-top": "40px"}),
